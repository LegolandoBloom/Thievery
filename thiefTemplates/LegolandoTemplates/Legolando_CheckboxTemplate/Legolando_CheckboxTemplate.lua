Legolando_CheckboxMixin_Thievery = {};

function Legolando_CheckboxMixin_Thievery:greyOut()
...
function Legolando_CheckboxMixin_Thievery:reposition()
...
function Legolando_CheckboxMixin_Thievery:OnClick()
...
Legolando_CheckboxesMixin_Thievery = {}

function Legolando_CheckboxesMixin_Thievery:Update()
